...
public class StringUtil  extends StringUtils {
    ...
    public static String format(CharSequence template, Object... params) {
        ...
        if (ObjectUtil.isEmpty(params) || isBlank(template)) {
    ...
    public static String underlineToHump(String para) {
        return StringUtil.anyToHump(para,"_");
    }
    ...
    public static String lineToHump(String para) {
        return StringUtil.anyToHump(para,"-");
    }
     ...
     * @return String
     */
    public static String anyToHump(String para,String regex){
        StringBuilder result = new StringBuilder();
        String[] a = para.split(regex);
        for (String s : a) {
            if (result.length() == 0) {
